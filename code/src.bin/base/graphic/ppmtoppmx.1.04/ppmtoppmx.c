...
/*
 $Log: ppmtoppmx.c,v $
 Revision 1.7  2005/08/05 20:10:51  barnes
 Added option to dump the command line options.

 Revision 1.6  2004/06/21 21:13:24  barnes
 Added missing header.

 Revision 1.5  2004/06/09 15:17:07  barnes
 Added the ability to set the mask based on non-zero luminance.

 Revision 1.4  2004/04/27 13:54:20  barnes
 Audit - Enforced warning set to "all".

 Revision 1.3  2004/04/26 18:50:07  barnes
 Removed redundant test for negative alpha.

 Revision 1.2  2004/04/26 18:48:40  barnes
 Fixed bug in determing percentage.

 Revision 1.1  2003/03/14 17:44:32  barnes
 Initial revision
