...
/*
 $Log: ssi.c,v $
 Revision 1.4  2004/04/27 16:50:19  barnes
 Audit - Enforced warning set to "all".

 Revision 1.3  2004/04/26 18:55:06  barnes
 Fixed bug in assigning buffer.

 Revision 1.2  2004/04/22 18:40:50  barnes
 Fixed bug in allocating text buffer.

 Revision 1.1  2003/05/01 14:03:23  barnes
 Initial revision
