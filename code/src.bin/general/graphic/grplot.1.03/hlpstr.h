...
char *hlpstr[]={
"grplot - A grPlot rendering engine.\n",
"grplot --help\n",
"grplot [options] [name]\n",
"grplot -ps [-land] [-xp xoff] [-yp yoff] [options] [name]\n",
"rplot -ppm [options] [name]\n",
"rplot -ppmx [options] [name]\n",
"rplot -xml [options] [name]\n",
"grplot -x [options] [-display display] [-xoff xoff] [-yoff yoff] [name]\n",

"--help\tprint the help message and exit.\n",
"-ippm ppmfiles\tcomma separated list of Portable PixMap (PPM) image files that will be used in the grPlot document.\n",
"-ippmx ppmfiles\tcomma separated list of extended Portable PixMap (PPMX) image files that will be used in the rPlot document.\n",
"-ixml ppmfiles\tcomma separated list of XML image representation files that will be used in the grPlot document.\n",
...
"name\tname of the grPlot document to plot, if this is omitted the document will be read from standard input.\n",
