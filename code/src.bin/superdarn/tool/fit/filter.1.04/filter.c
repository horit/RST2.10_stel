...
/*
 $Log: filter.c,v $
 Revision 1.5  2006/03/14 22:12:45  barnes
 Modification to deal with radars with extra beams.

 Revision 1.4  2005/08/10 18:28:04  barnes
 Added option to dump out command line options.

 Revision 1.3  2004/10/28 13:58:00  barnes
 Added missing header.

 Revision 1.2  2004/05/10 21:34:06  barnes
 Removed redundant code.

 Revision 1.1  2003/04/25 14:51:22  barnes
 Initial revision

*/


struct CFitdata ocfit;
      ...
      if ((chk==0) && (num>=nbox)) {
	    ...
	    ocfit.atten=out->bm[n].atten;
	      ...
	      if (out->bm[n].sct[r]==0) continue;
              ocfit.rng[ocfit.num]=r;
              ocfit.data[ocfit.num].gsct=out->bm[n].rng[r].gsct;
	      ocfit.data[ocfit.num].p_0=out->bm[n].rng[r].p_0;
	      ocfit.data[ocfit.num].p_0_e=out->bm[n].rng[r].p_0_e;
              ocfit.data[ocfit.num].v=out->bm[n].rng[r].v;
	      ocfit.data[ocfit.num].v_e=out->bm[n].rng[r].v_e;
	      ocfit.data[ocfit.num].p_l=out->bm[n].rng[r].p_l;
              ocfit.data[ocfit.num].p_l_e=out->bm[n].rng[r].p_l_e;
	      ocfit.data[ocfit.num].w_l=out->bm[n].rng[r].w_l;
              ocfit.data[ocfit.num].w_l_e=out->bm[n].rng[r].w_l_e;
              ocfit.num++;
	    } 
                   

            CFitFwrite(stdout,&ocfit);
