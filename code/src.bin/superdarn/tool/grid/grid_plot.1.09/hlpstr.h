...
"-vecccol rrggbb\tif a colorkey is not used then set the color of vectors rrggbb, specified as the hexadecimal value for the 24-bit red,green and blue component color.\n",
