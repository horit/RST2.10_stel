...
; ---------------------------------------------------------------
; $Log: rawlib.pro,v $
; Revision 1.4  2005/07/25 20:41:31  barnes
; Fixed problem in setting the file offset in read_raw.
;
; Revision 1.3  2004/08/27 22:24:09  barnes
; Fixed bug in moving the file pointer.
;
; Revision 1.2  2004/08/27 19:16:08  barnes
; Replaced point_lun, with OldRawPoint
;
