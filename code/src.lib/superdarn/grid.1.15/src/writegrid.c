...
/*
 $Log: writegrid.c,v $
 Revision 1.4  2005/01/13 14:52:42  barnes
 Fixed data types.

 Revision 1.3  2004/10/12 20:57:20  barnes
 Set the index type to int32.

 Revision 1.2  2004/10/08 20:09:11  barnes
 Now use the DataMap format.

 Revision 1.1  2004/08/20 13:50:35  barnes
 Initial revision
