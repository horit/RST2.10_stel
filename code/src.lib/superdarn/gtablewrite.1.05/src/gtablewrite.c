...
/*
 $Log: gtablewrite.c,v $
 Revision 1.5  2005/01/13 14:51:44  barnes
 Fixed data types.

 Revision 1.4  2004/10/19 16:24:59  barnes
 Fixed bug in the output format - index is an integer not short.

 Revision 1.3  2004/10/08 16:13:49  barnes
 Fixed code to ignore empty records.

 Revision 1.2  2004/10/07 22:14:47  barnes
 Fixed some typos.

 Revision 1.1  2004/10/07 19:48:22  barnes
 Initial revision
